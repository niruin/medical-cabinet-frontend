...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    usersControllerRemove: async (
      ...
      assertParamExists('usersControllerRemove', 'deleteUserDto', deleteUserDto);
...
export const UsersApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async usersControllerRemove(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.usersControllerRemove(
        deleteUserDto,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
...
export const UsersApiFactory = function (
  ...
  return {
    ...
    usersControllerRemove(
      requestParameters: UsersApiUsersControllerRemoveRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .usersControllerRemove(requestParameters.deleteUserDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
