...
export const ScheduleApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    scheduleControllerList: async (
      doctorId: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'doctorId' is not null or undefined
      assertParamExists('scheduleControllerList', 'doctorId', doctorId);
     ...
     * @throws {RequiredError}
     */
    scheduleControllerRemove: async (
      scheduleRemoveOneRequest: ScheduleRemoveOneRequest,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'scheduleRemoveOneRequest' is not null or undefined
      assertParamExists(
        'scheduleControllerRemove',
        'scheduleRemoveOneRequest',
        scheduleRemoveOneRequest,
      );
...
export const ScheduleApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async scheduleControllerCreate(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.scheduleControllerCreate(
        createScheduleDto,
        options,
      );
     ...
     * @throws {RequiredError}
     */
    async scheduleControllerList(
      doctorId: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ScheduleListResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.scheduleControllerList(
        doctorId,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
     ...
     * @throws {RequiredError}
     */
    async scheduleControllerRemove(
      scheduleRemoveOneRequest: ScheduleRemoveOneRequest,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.scheduleControllerRemove(
        scheduleRemoveOneRequest,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    ...
    async scheduleControllerUpdate(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.scheduleControllerUpdate(
        changeScheduleDto,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
...
export const ScheduleApiFactory = function (
  ...
  return {
    ...
    scheduleControllerCreate(
      ...
      return localVarFp
        .scheduleControllerCreate(requestParameters.createScheduleDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     * @param {ScheduleApiScheduleControllerListRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    scheduleControllerList(
      requestParameters: ScheduleApiScheduleControllerListRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<ScheduleListResponse> {
      return localVarFp
        .scheduleControllerList(requestParameters.doctorId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    scheduleControllerRemove(
      requestParameters: ScheduleApiScheduleControllerRemoveRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .scheduleControllerRemove(requestParameters.scheduleRemoveOneRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    scheduleControllerUpdate(
      ...
      return localVarFp
        .scheduleControllerUpdate(requestParameters.changeScheduleDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
/**
 * Request parameters for scheduleControllerList operation in ScheduleApi.
 * @export
 * @interface ScheduleApiScheduleControllerListRequest
 */
export interface ScheduleApiScheduleControllerListRequest {
  /**
   *
   * @type {string}
   * @memberof ScheduleApiScheduleControllerList
   */
...
export class ScheduleApi extends BaseAPI {
   ...
   * @memberof ScheduleApi
   */
  public scheduleControllerRemove(
    requestParameters: ScheduleApiScheduleControllerRemoveRequest,
    options?: AxiosRequestConfig,
  ) {
    return ScheduleApiFp(this.configuration)
