...
export const PatientsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    patientsControllerList: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const PatientsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async patientsControllerList(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.patientsControllerList(options);
...
export const PatientsApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    patientsControllerList(options?: AxiosRequestConfig): AxiosPromise<void> {
      return localVarFp.patientsControllerList(options).then((request) => request(axios, basePath));
    },
  };
};
...
export class PatientsApi extends BaseAPI {
   ...
   */
  public patientsControllerList(options?: AxiosRequestConfig) {
    return PatientsApiFp(this.configuration)
      .patientsControllerList(options)
